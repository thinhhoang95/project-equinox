...
Usage:
    python visualize_cost_functions.py [--case-dir path] [--checkpoint name]
    
Examples:
    # Use default case directory and latest checkpoint
    python visualize_cost_functions.py
    
    # Specify case directory and save plots
    python visualize_cost_functions.py --case-dir data/cases/LEMD_EGLL --save-plots
    
    # Use specific checkpoint
    python visualize_cost_functions.py --checkpoint checkpoint_iter_50.pt
"""
