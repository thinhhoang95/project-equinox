...
# ---------------- Narrow‑body jet ------------ 
NARROW_BODY_JET_CLIMB_PROFILE  = [(10000, 250), (20000, 330), (28000, 390), (float('inf'), 460)]
NARROW_BODY_JET_DESCENT_PROFILE= [(10000, 250), (20000, 300), (28000, 360), (float('inf'), 450)]
NARROW_BODY_JET_CLIMB_VS_PROFILE = [(10000, 3000), (28000, 2000), (float('inf'), 1200)]

# ---------------- Wide‑body jet --------------
WIDE_BODY_JET_CLIMB_PROFILE    = [(10000, 250), (20000, 340), (30000, 400), (float('inf'), 490)]
WIDE_BODY_JET_DESCENT_PROFILE  = [(10000, 250), (30000, 320), (41000, 460), (float('inf'), 490)]
...
BUSINESS_JET_DESCENT_PROFILE   = [(10000, 250), (25000, 340), (45000, 480), (float('inf'), 480)]
