...
def haversine_distance_matrix(graph: nx.Graph) -> np.ndarray:
    ...
    0 for the distance from a node to itself, and the great-circle distance
    in nautical miles otherwise.
    ...
    Returns:
        np.ndarray: A square matrix where M[i, j] is the great-circle
                    distance (nautical miles) between node_i and node_j, or np.inf
