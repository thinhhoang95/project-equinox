...
def backward_gradient_pass(
    ...
    if torch.isinf(log_partition_z):
        ...
        return link_traversal_likelihoods, torch.zeros(num_cost_params, dtype=torch.float64, device=device)
    ...
    return link_traversal_likelihoods, total_log_likelihood_grad
