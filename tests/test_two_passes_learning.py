...
def get_configuration():
    ...
    estimated_landing_eta = datestr_to_seconds_since_midnight(estimated_landing_time_str) # seconds since midnight
...
if __name__ == "__main__":
    ...
    V_b, eta_b, alt_b, phase_b, edge_costs_time_binned, edge_cost_gradients_time_binned, edge_to_canonical_idx = run_backward_dp(
        graph=G,
