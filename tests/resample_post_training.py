...
if __name__ == '__main__':
    ...
    components = config.initialize_all_components(cost_model_version="3", manual_cost_model_init = True)
    ...
    # Same for the cost model
    cost_model = config.initialize_cost_model(num_waypoints=components['num_nodes'], cost_model_version="3")
