...
def test_narrow_body_jet():
    ...
    climb_etas = flight_performance.get_climb_eta(origin_airport_elevation_ft = origin_airport_elevation_ft)
    ...
    descent_etas = flight_performance.get_descent_eta(destination_airport_elevation_ft = destination_airport_elevation_ft)
    print(f'{'Alt':<10} {'Time (min)':<10}')
    print('-' * 20)
