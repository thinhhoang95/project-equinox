...
from equinox.dp.backward_dp_toc import run_backward_dp
...
def test_backward_dp_with_toc():
    ...
    try:
        ...
        V_final, eta_final, alt_final, phase_final = run_backward_dp(
            graph=G,
